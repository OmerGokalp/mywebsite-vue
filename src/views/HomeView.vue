...
<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-100 flex items-center justify-center px-4 py-10">
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl max-w-3xl w-full p-8 text-center">
      <!-- Profil Fotoğrafı -->
      ...
      <!-- İsim -->
      <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Ömer Gökalp</h1>
